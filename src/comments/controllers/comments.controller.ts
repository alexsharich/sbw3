...
import {InputCommentType, LikeStatus} from "../../input-output-types/comments.type";
...
export class CommentsController {
    ...
    async updateCommentLikeStatus(req: Request<{ commentId: string }, {}, { likeStatus: LikeStatus }>, res: any) {
        const userId = req.userId!
        const isCommentLikeStatusUpdated = await this.commentsService.updateLikeStatus(req.body.likeStatus, req.params.commentId, userId)
